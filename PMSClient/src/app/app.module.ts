...
@NgModule({
  ...
  entryComponents: [UpdateMemberDialogBoxComponent, UpdateProjectDialogBoxComponent, AddTaskComponent, UpdateTaskDialogBoxComponent,ChangePasswordComponent,ProfileDialogBoxComponent]
})
